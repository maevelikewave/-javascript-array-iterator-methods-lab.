...
// YOU HAVE TO ADD THE INVENTOR.YEAR PART EVERY GODDAMN TIME.
...
const inventorTitles = inventors.map((inventor) => {
    const inventorNames = {
        first: inventor.name,
        last: inventor.last
    }
...
const inventorNamedAda = inventors.find(({ first }) => first === "Ada");
...
// map is a sensible choice because it transforms every element into something else
// frist
...
//     // do something
//    console.log(person)  //the string 'Last , First"
// })

/*
//Just solve this
const person  = 'Becker, carl'
"last, first "  => 'First, Last"
return parts = person.split(',)    //   can split a sting into parts TRANSFORMED INTO AN ARRAY
 // === [ 'Becker], ' carl]
 const newName = parts[1] + 'space' + parts[0]
*/
